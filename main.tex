...
\begin{example}
A mixture of 3 exponential distributions with rates $\lambda_1, \lambda_2, \lambda_3$ with weights $(\alpha_1, \alpha_2, \alpha_3)$ can be represented as a phase-type distribution:
\begin{align*}
...
\section{Voter Model on Finite Graphs}
...
\subsection{Simulation of Linear Voter Model}
