...
%\begin{align*}
%    E[T_\lambda] &= \sum_{n = 0}^\infty E[T_{\lambda, N} | N = n] P(N = n)\\
%    &= E[S_2] + E[S_{1 + \lambda}] + (E[S_2] + E[S_{1 + \lambda}]) \sum_{n = 1}^\infty n \left(\frac{\lambda}{1 + \lambda} \right)^n \frac{1}{1 + \lambda}\\
%    &= (E[S_2] + E[S_{1 + \lambda}])\left(1 + \frac{1}{1 + \lambda} \cdot \frac{\lambda}{1 + \lambda} \sum_{n = 1}^\infty n \cdot \left(\frac{\lambda}{1 + \lambda} \right)^{n - 1} \right)\\
%    &= \left(\frac{1}{2} + \frac{1}{1 + \lambda} \right) \left(
%        1 + \frac{\lambda}{(1 + \lambda)^2} \cdot (1 + \lambda)^2
%    \right) \\ %&& \sum_{n = 1}^\infty n \cdot p^{n - 1} = \frac{1}{(1 - p)^2}, |p| < 1 \\
%    &= \frac{3 + \lambda}{2(1 + \lambda)} (1 + \lambda)\\
%    &= \frac{\lambda^2 + 4\lambda + 3}{2(1 + \lambda)}\\
%    &= \frac{(1 + \lambda)(3 + \lambda)}{2 (1 + \lambda)}\\
%    &= \frac{3}{2} + \frac{1}{2} \lambda
%\end{align*}
