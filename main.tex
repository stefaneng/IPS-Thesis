...
\chapter*{Abstract}
Phase-type distributions model the absorption time in an absorbing Markov chain with one absorbing state.
We look at the phase-type distributions of the linear voter model and the contact process on finite graphs.
The limiting distribution of the contact process is computed for a fixed sized graph as the infection rate goes to infinity.
