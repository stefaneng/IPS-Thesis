...
In Figure \ref{fig:contact_2_phase_densities} we plot the density from Equation \ref{eq:t_density} for various values of $\lambda$.
...
We plot the density functions for $T_\lambda$ for $\lambda = 1, 2, 5, 15$ on the complete three node contact process.

\begin{figure}
  \centering
    \includegraphics[width=.80\textwidth]{figures/complete_3_contact_phase_densities.png}
   \caption{Density functions for $T_\lambda$ for $\lambda = 1, 2, 5, 15$ on the complete three node contact process}
